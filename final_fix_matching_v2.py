...
start_marker = "setTimeout(drawLines, 150);"
end_marker = "function parseAnswerToIndex(val)"
...
" + new_js_logic + "
    ...
    with open(file_path, 'w', encoding='utf-8') as f:
        f.write(new_content)
    print("SUCCESS: Cleaned up and restored correct logic.")
else:
