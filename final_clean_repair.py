    ...
    function submitExam() {
        ...
        examQuestions.forEach((item, idx) => {
            ...
            if (item.type === 'matching' || item.type === 'multimatching') {
                ...
                // --- F12 Debug Message ---
                console.log(`%c[Grading Q${idx+1}] Type: ChoiceList`, "color: #0d6efd; font-weight: bold;");
                console.log(` - 您的答題 (Indices):`, userIdxs);
                console.log(` - 正確答案 (Indices):`, correctIndices);
                console.log(` - 原始正確標籤:`, answers);
                console.log(` - 轉換規則說明: A=0, B=1, C=2, D=3, E=4 (以此類推)`);
                if (!isCorrect) {
                    console.log(`%c - 判定結果: ❌ 錯誤`, "color: red; font-weight: bold;");
                } else {
                    console.log(`%c - 判定結果: ✅ 正確`, "color: green; font-weight: bold;");
                }
