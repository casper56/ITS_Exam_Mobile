...
<head>
    ...
    <style>
        ...
        @media (max-width: 992px) {
            ...
            .mobile-toggle { display: block !important; bottom: 20px; right: 15px; width: 45px; height: 45px; opacity: 1.0; }
            .home-float-btn { bottom: 75px; right: 15px; width: 45px; height: 45px; font-size: 1.5rem; opacity: 1.0; border-width: 2px !important; }
            .zoom-controls { bottom: 130px; right: 15px; gap: 10px; }
            .zoom-btn { width: 45px; height: 45px; font-size: 1.5rem; opacity: 1.0; border-width: 2px !important; }

            .side-nav-btn { width: 33px; height: 50px; font-size: 0.9rem; background: rgba(33, 37, 41, 0.6); }            .side-nav-btn.side-nav-prev { left: 0; border-radius: 0 15px 15px 0; }
