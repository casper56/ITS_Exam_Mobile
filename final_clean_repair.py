    ...
    <style>
        ...
        @media print {
            ...
            * { box-sizing: border-box !important; -webkit-print-color-adjust: exact; overflow: visible !important; }
            ...
            .main-wrapper, .mobile-toggle, .side-nav-btn, .no-print, .sidebar, .zoom-controls, .home-float-btn { display: none !important; visibility: hidden !important; position: absolute !important; top: -9999px !important; }
