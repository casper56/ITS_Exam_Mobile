const quizData = [
    ...
    },
    {
        ...
        "explanation": [
            ...
            "",
            "解題分析：",
            "● 如果答案是監督式學習、分類： 如果銀行有歷史交易資料，並且每筆交易都被標記為「詐騙」或「非詐騙」，那麼這就是一個典型的監督式學習中的分類問題，",
            "目標是訓練一個模型來區分這兩類交易。",
    ...
    },
    {
        ...
        "type": "multioption",
        "question": [
            "<pre><code>36. 這三個模型使用的都是同一個資料集。<br>[[image01]]<br>    (1) 模型 1 <br>(2) 模型 2<br>(3) 模型 3<br></code></pre>"
        ],
        "options": [
        ...
        "explanation": [
            ...
            "模型3過於緊密地貼合了訓練數據中的每一個點，包括噪聲，這很可能導致在新的、未見過的數據上表現不佳，屬",
            "於過度擬合。",
            "過度擬合（Overfitting）：指的是模型在訓練數據上表現很好，但在未見過的測試數據上表現較差。模型3的擬合線",
            "幾乎穿過了所有的訓練數據點，這通常是過度擬合的表現，它學習了訓練數據中的噪聲和特定模式，而不是潛在的",
            "一般規律。",
