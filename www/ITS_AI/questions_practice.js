const quizData = [
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您需要為醫療技術人員建立一套容易解釋的導引系統。請問您應該使用哪種機器學習模型?</code></pre>"
    ],
    "options": [
      "<code>決策樹</code>",
      "<code>支援向量機</code>",
    ...
    "explanation": [
      ...
      "● K-Means：是無監督學習的叢集演算法，不適用於建立導引系統（通常是分類或回歸問題）。</code></pre>"
    ],
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您想將視覺資訊編碼成機器視覺系統能夠解譯的形式,但記憶體需求和模型大小都有限制。請問在相同的解析度下,下列哪種像資料所需的磁碟使用量最小?</code></pre>"
    ],
    "options": [
      "<code>單色</code>",
      "<code>灰階</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>請將選項中各個資料集片段,填入會用到該片段的AI建模步驟:「訓練和建模」</code></pre>"
    ],
    "options": [
      "<code>訓練資料集</code>",
      "<code>驗證資料集</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>請將選項中各個資料集片段,填入會用到該片段的AI建模步驟:「在新審例上評估模型」</code></pre>"
    ],
    "options": [
      "<code>訓練資料集</code>",
      "<code>驗證資料集</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>請將選項中各個資料集片段,填入會用到該片段的AI建模步驟:「訓練超引數」</code></pre>"
    ],
    "options": [
      "<code>訓練資料集</code>",
      "<code>驗證資料集</code>",
  ...
  },
  {
    ...
    "category": "D3_AI演算法與模型"
  },
  {
    "id": 7,
    "type": "single",
    "question": [
      "<pre><code>下列哪個應用程式實作時並未使用 AI?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>一間汽車經銷公司想根據先前的銷售資料,使用AI預測任何指定日期的來客數,以便運用這項資料制定每週計畫。對這間經銷公司而言,最重要的AI模型成功指標是什麼?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>一間保險公司會根據客戶對於10個是非題的答案判斷他們是否符合折扣資格;公司的CEO想要制定一項用於判斷客戶優惠資格的計畫,代替保險代理人詢問這些問題。這項計畫必須盡可能達到快速可靠的成效,CEO詢問針對這種情形,您會推薦使用哪種AI。請問您該如何回答這位CEO?</code></pre>"
    ],
    "options": [
      "<code>在這種情況下,AI並非效率最高的解決方案因為這個問題只需使用少數決策陳述式就能處理妥當。</code>",
      "<code>叢集演算法能將答案類似的客觀分入同一折扣群組,因此是最佳解決方案。</code>",
      "<code>神經網路能根據客戶對問題的答案學會預測對方的保險折扣獲取資格,因此是最佳解決方案。</code>",
      "<code>由於所有折扣類別都已經有充足的代表性訓練資料,因此無論使用哪種機器學習演算法,都能快速學會正確的折扣類別。</code>"
    ],
    "answer": [
      "A"
    ],
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>哪種人工智慧演算法或應用程式會使用未標記資料?</code></pre>"
    ],
    "options": [
      "<code>叢集</code>",
      "<code>物件偵測</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>一間銀行希望能偵測出詐騙交易。這間銀行能夠收集每筆交易的資料,例如金額、購買的品項。請問這屬於哪種機器學習問題?</code></pre>"
    ],
    "options": [
      "<code>監督式學習、分類</code>",
      "<code>增強式學習、遊戲</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您和團隊成員在開發一款能在電動遊戲中作為對手的產品。團隊根據獎勵使用演算法,也就是假如產品表現越佳,成果品質越優異。請問這屬於哪一種機器學習?</code></pre>"
    ],
    "options": [
      "<code>增強式學習</code>",
      "<code>監督式學習</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>與您敵對或不懷好意的有心人士可能透過惡意探索哪方面的問題以攻擊或暗中破壞 AI系統?</code></pre>"
    ],
    "options": [
      "<code>資料擷取</code>",
      "<code>過度擬合</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>為什麼AI專案團隊裡必須有不具備技術專業知識的領域專家?</code></pre>"
    ],
    "options": [
      "<code>為了將特定領域資料加入演算法,使AI系統客觀有效率</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>貴組織正在針對特定用途開發一套AI系統,但這套系統也能輕易用於其他用途。請問具備多種潛在用途的系統為什麼會產生道德疑慮?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>數間公司共同建立並監視一個特定產業的AI相關安全性事件資料庫,希望藉由共享資訊,讓業部署的AI系統更安全。請問哪一位專案團隊成員應負責監視 AI事件資料庫中的事件?</code></pre>"
    ],
    "options": [
    ...
    "category": "D5_生產環境維護與監控"
  },
  {
    "id": 17,
    "type": "single",
    "question": [
      "<pre><code>一位學校諮商師想瞭解招生嚴格的明星大學主要的錄取標準,他應該使用哪種資料才能訓練出成效最佳的機器學習模型?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>一間公司提供使用者非常多種類的產品;他們想將產品整理成不同組別,以便針對每組產品分別制定行銷策略。請問這屬於哪種機器學習問題?</code></pre>"
    ],
    "options": [
      "<code>監督式學習、叢集</code>",
      "<code>監督式學習、迴歸</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您的團隊正在打造一個農業機器人,這個機器人會使用視覺系統辨識雜草,然後以不傷害到周圍作物的方式清除雜草。您的任務是為這項專案開發一個訓練資料集。請問這個訓練集中應加入哪些影象?為什麼?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>一間公司開發了一款智慧型手機用程式,可使用GPS 與加速計資料辨識並回報城市街道上的路面坑洞。他們原先的目的是協助為數千個需要填補的路面坑洞分配資源,但城裡許多老年人和低收入居民都沒有智慧型手機,因此導致資料集產生偏差,僅有富裕的社群受益。請問這是哪種偏差型別的例子?</code></pre>"
    ],
    "options": [
      "<code>自動化偏差</code>",
      "<code>資料收集偏差</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您正在建置一個模型,想用於預測內送電子郵件是否為垃圾郵件。下表顯示了資料集的代表性範例。請問在此資料集中,有什麼問題是您必須解決的?</code></pre>"
    ],
    "options": [
      "<code>資料毀損</code>",
      "<code>資料不平衡</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>請將清單中各個AI問題移至最適當的資料型別:「時間序列資料」</code></pre>"
    ],
    "options": [
      "<code>各個地區的投票模式</code>",
      "<code>物件辨識</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>請將清單中各個AI問題移至最適當的資料型別:「表格式資料」</code></pre>"
    ],
    "options": [
      "<code>各個地區的投票模式</code>",
      "<code>物件辨識</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>請將清單中各個AI問題移至最適當的資料型別:「文字資料」</code></pre>"
    ],
    "options": [
      "<code>各個地區的投票模式</code>",
      "<code>物件辨識</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>請將清單中各個AI問題移至最適當的資料型別:「圖像資料」</code></pre>"
    ],
    "options": [
      "<code>各個地區的投票模式</code>",
      "<code>物件辨識</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您正在建置一個AI,用於預測是該核准客戶的貸款申請。因為貴公司對自家客戶知之甚詳,所以您手的資料包含許多特徵,但一開始您只想使用最有價值的特徵,以便將AI的成功率提到最高。請問您該怎麼做?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您有下列資料集。</code></pre>[[image01]]<pre><code>您必須認識到上列哪些表格使用了資料的分類限界辦識的轉換方法。請問哪個表格使用了 One-Hot Encoding?</code></pre>"
    ],
    "options": [
      "<code>表格 A</code>",
      "<code>表格 B</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您正在製作一個模型,用於估計北極被冰層覆蓋的土地面積。您擁有10萬張具有標籤的北極圈衛星影象,可用於訓練機器學習模型區分冰層、水域、土地,以產生土地面積估計值。請問您該如何將影象配置給訓練和測試資料集?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您建置了兩個AI,用於區分成人和兒童,各個AI的混淆矩陣如下所示。(圖片顯示兩個混淆矩陣。矩陣1：預測成人/實際成人 3, 預測兒童/實際成人 2, 預測成人/實際兒童 2, 預測兒童/實際兒童 3。準確率 = (3+3)/(3+2+2+3) = 6/10 = 60%。矩陣2：預測成人/實際成人 0, 預測兒童/實際成人 2, 預測成人/實際兒童 0, 預測兒童/實際兒童 8。準確率 = (0+8)/(0+2+0+8) = 8/10 = 80%。) 哪個AI較佳?為什麼?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "multioption",
    "question": [
      "<pre><code>這三個模型使用的都是同一個資料集。</code></pre>[[image01]]<pre><code>(1) 模型 1 (2) 模型 2(3) 模型 3</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>這張圖表依據性別和年份顯示擁有銀行帳戶的人口百分比。請問這屬於哪種視覺效果? (圖片顯示男性和女性擁有銀行帳戶百分比隨年份變化的折線圖)</code></pre>[[image01]]"
    ],
    "options": [
      "<code>交集</code>",
      "<code>長期變化</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>哪種指標經常用於評估迴歸AI的品質?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您需要對使用交易資料進行訓練的詐騙偵測模型進行成效評估。請問您應該使用哪一種指標?</code></pre>"
    ],
    "options": [
      "<code>混淆矩陣</code>",
      "<code>確判為真率</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>準確率和精確率有什麼差異?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>如想避免決策樹發生過度擬合的情形,可以採取哪些做法?</code></pre>"
    ],
    "options": [
      "<code>指定樹深上限</code>",
      "<code>決定葉節點數目下限</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>一間學校使用AI模型協助處理入學事宜...輸入值排除申請人的收入資料,但學校發現...結果雖然實用,卻依然偏向收入較高的學生。下列何者可能是造成這種情況的原因?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>下列哪些物件可以協助AI專案團隊管理法規合規性?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>貴公司建置了臉部辨識軟體,計劃部署在辦公大樓作為保安系統的一環。您負責制定訓練計畫,協助大樓保全人員瞭解如何使用這套軟體。請問您的訓練計畫應該包括哪些內容?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>一間銀行建置了AI,用於預測客戶是否可能拖欠貨款...銀行想確實保留相關記錄,以便向客戶說明決策的方式。請問銀行應該提供下列哪項資訊以減少未來發生的爭議?</code></pre>"
    ],
    "options": [
      "<code>用於訓練AI的資料集</code>",
      "<code>編寫預測程式碼的工程師</code>",
      "<code>為了選出最佳演算法而執行的訓練實驗次數</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>下列哪個詞彙經常用於形容AI預測結果?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>貴公司的目標是執行高度相關且隨時都有最佳效能的模型。您必須決定模型重新接受訓練的頻率...除了回饋意見的可用性和資料量以外,您進行評估時還應納入哪項重要因素?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您將訓練用於區分貓、狗、兔子的AI應用程式部署至生產環境。請問下列哪種情況是在生產環境發生模型漂移的例子?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您將對網站使用者推薦產品的AI部署至生產環境後,該AI已在生產環境超過一年;上週由於資料科學家發現新的演算法,這個AI加入了新的模型更新。請問您該如何評估新演算法是否能比舊演算法實現更高的業務效益?</code></pre>"
    ],
    "options": [
      "<code>等待三個月後,將新演算法與舊演算法的推薦產品銷售量進行比較</code>",
      "<code>檢閱資料科學家的實驗,確認他們在相同的測試案例上對新舊兩種演算法都進行了評估</code>",
      "<code>檢視新舊兩種演算法的程式碼,確認哪一種的錯誤比較多</code>",
      "<code>將使用舊演算法時每年最忙碌的購物日銷售量,與第一天啟用新演算法的銷售量進行比較</code>"
    ],
    "answer": [
      "A"
    ],
    ...
    "image": null,
    "explanation": [
      "<pre><code>● 評估業務效益最直接的方法是比較關鍵業務指標（KPI），例如本例中的「推薦產品銷售量」，A/B測試是常用的方法，但如果無法進行嚴格的A/B測試，則在一段合理的時間（如三個月，以消除短期波動影響）後比較新舊演算法的表現是一個可行的方法。",
      "● 檢閱資料科學家的實驗是評估模型效能而非業務效益。",
      "● 檢視新舊兩種演算法的程式碼是關注程式碼錯誤而非效益。",
      "● 使用舊演算法時與第一天啟用新演算法比較時，比較的時間點和週期不具可比性。</code></pre>"
    ],
    "category": "D4_應用整合與部署"
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您的新AI系統已經順利透過測試,現在您可以開始收集實際運作指標。所有結果看來都符合預期,您希望很快就能開始全面部署系統。請問在這個階段,您應該採取什麼重要且合乎道德的步驟?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>一間雜貨商店在網站上使用AI推薦顧客值得購入的產品,這個AI已經運作了好幾個月。決定是否要繼續使用這個AI時,商店應考慮下列哪項因素?</code></pre>"
    ],
    "options": [
      "<code>AI的推薦是否使顧客的採購量增加</code>",
      "<code>AI原始的準確度是否超過85%</code>",
      "<code>AI使用的是監督式還是非監督式演算法</code>",
      "<code>AI是否使用了可解釋的演算法</code>"
    ],
    "answer": [
      "A"
    ],
    ...
    "explanation": [
      ...
      "● 技術細節如準確度閾值、演算法型別或可解釋性，雖然在開發和評估階段重要，但最終的商業決策應基於其對業務目標的貢獻。</code></pre>"
    ],
    "category": "D1_AI問題定義與倫理"
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>一間博物館收集了15年份的詳細訪客資訊,包含有時間戳記的入館和出館資訊。博物館館長想請您使用這些資料開發一個AI模型,用於判斷博物館在特定日期的特定時間有多少訪客。請問您應該給這位館長什麼建議?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>一間公司想更深入瞭解客戶,藉此提高客戶滿意度。為達成這個目標,首先他們想依照客戶個人檔案和購物紀錄間的相似之處,將客戶分類。請問這屬於哪種機器學習問題?</code></pre>"
    ],
    "options": [
      "<code>增強式學習</code>",
      "<code>非監督式學習</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>下列哪個問題可以使用迴歸解決?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>下列哪一項AI問題屬於分類問題?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您接到一份工作,內容是用AI根據氣溫、首次降雪日期、降水量等環境和氣候特徵,預測當地的年度河魚數量。請問這個案例為什麼應該使用迴歸模型?</code></pre>"
    ],
    "options": [
      "<code>因為輸出值是量化值</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>在哪種情況下,比起自己開發AI 解決方案,不如直接購買現成方案?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>一間銀行計畫透過實作AI,判斷哪謝客戶能以特殊低利率進行貸款。您負責規劃如何將AI投入生產環境,並為客戶做好準備。此外,您也必須確保銀行可以在系統中建立透明度。請問下列哪項活動至關重要?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>下列哪一個詞是指讓私人公司、研究機構、政府機關共享資料,以解決公共問題?</code></pre>"
    ],
    "options": [
      "<code>資料協作</code>",
      "<code>資料交換</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>一間公司想要確認消費者對於新產品的意見,因此想在社群媒體平臺上進行情感分析,但是潛在消費者的數量非常多。請問這間公司該如何以結構化方式收集所需資料?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>一間大型跨國公司希望使用AI篩選求職者的履歷,以便找出最可能表現傑出的人才。他們提供您10年份的員工績效審查結果作為訓練資料。請問您應該對這項資料提出什麼疑慮?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您必須將文字資料集轉換成機器學習模型能夠解讀的形式。請問您應該使用哪一種技術?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您正在建置一套系統,用於協助一間健身房判斷哪些客戶最可能取消會員資格。您取得的客戶資料中含有100多種特徵。請問您該如何有效挑選對AI而言實用的特徵?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>數間公司共同建立並監視一個特定產業的AI 相關安全性事件資料庫,希望藉由共享資訊,讓業界部署的AI系統更安全。請問哪一位專案團隊成員應負責監視 AI事件資料庫中的事件?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>為了提升準確率,在選擇特徵的階段應該移除哪一類特徵?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您正在建置迴歸AI,以便預測車輛價格,且會在進行特徵工程時使用一位有效編碼(one-hot encoding)。請問您必須對哪類特徵使用一位有效編碼?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>請問哪一項技術可協助減少AI模型輸入資料集的維度?</code></pre>"
    ],
    "options": [
      "<code>主成分分析</code>",
      "<code>一位有效編碼</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您在建置一個AI模型。您應該對初始資料集採用哪一種方法?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>一間公司負責做貸款的核準決定,但一名顧客對於AI的結論有異議。為了進行稽核,必須準備下列哪種型別的檔案?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>線性迴歸和邏輯迴歸有什麼差異?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您想藉由發掘對比資料中蘊藏的意義,呈現正式金融帳戶的存取率,以及擁有足以負擔基本日常必需品的財產之間有何關聯。請問您的資料集必須符合哪些需求?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>模型低度擬合代表什麼意思?</code></pre>"
    ],
    "options": [
      "<code>方差低,偏差高</code>",
      "<code>方差高,偏差低</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您正在建置一個AI模型,用於辨識業餘賞鳥人士拍攝的照片中出現的各種不同鳥類。您剛訓練完模型,並讓模型對一組先前沒有看過的影象進行預測作為測試。為了計算模型的精確率,您應該採用哪種計算方式?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>一個銀行組織的AI團隊實作了一個模型,用於預測交易是否涉及詐騙;結果訓練集的準確率雖然高達99.7%,測試集的準確率卻只有72.45%,請問下列哪一項解釋符合上述資訊?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您是一個AI模型開發團隊的專案經理,這個AI的用途是向客戶推薦產品,不過您必須先取得專案關係人的核準,才能將AI推出給客戶。這個專案只是貴公司眾多AI專案的其中一個。請問哪些人可能會是專案關係人?</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>一間銀行建置了AI,用於預測哪客戶有可能關閉銀行帳戶,改到其他銀行開戶。在實際開始運用這個AI以前,\n銀行必須先訓練未來負責使用AI的員工,協助他們瞭解如何讓AI發揮最佳效能。請問這項訓練應該包含哪些內容?</code></pre>"
    ],
    "options": [
      "<code>這個AI能夠預測的型別,以及用於進行預測的資訊</code>",
      "<code>AI進行預測時使用的演算法,以及用於評估AI的指標</code>",
    ...
    "explanation": [
      ...
      "● 技術細節如演算法、程式語言或訓練資料量對終端使用者而言通常不是最重要的。</code></pre>"
    ],
    "category": "D1_AI問題定義與倫理"
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>您必須決定是否要為自己兩年前開發的AI系統進行升級。請問您應該依照什麼順序完成動作? 請將所有動作按照正確的順序排列。</code></pre>[[image01]]"
    ],
    "options": [
      "<code>ACBED</code>",
      "<code>CDABE</code>",
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>一間動物醫院聘請您擔任專案經理,他們想使用機器學習技術預測透過X光找到的貓狗腫瘤中,有哪些特徵能為不同患者進行最準確的風險分類。...請問您會選擇讓下列哪兩位人員加入團隊?(請選擇2個答案。)</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>您正在為有特定目標的模型選擇資料集。在選擇有助於達成目標的資料集時,下列哪兩項因素可能是重要的元素?(請選擇2個答案。)</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>請將清單中的各項描述對應至資料儲存型別:「雲端儲存空間」</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>請將清單中的各項描述對應至資料儲存型別:「本機伺服器」</code></pre>"
    ],
    "options": [
      "<code>包含安裝及維護硬體的費用</code>",
      "<code>費用會隨著特定時間所需的空間大小而變動</code>",
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>資料科學家會使用這個表格中顯示的資料預測來年客戶會透過銀行投資多少錢。",
      "請問在選擇特徵的階段,資料科學家應該移除哪兩欄資料?為什麼?(請選擇2個答案。)",
      "表格資料: 客戶_ID, 年齡, 城市, 學歷, 出生年, 薪資 (其中城市均為紐約市)</code></pre>[[image01]]"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>一間醫院正在打一套AI解決方案,用於預測患者是否可能取消約診。...標籍為「是」(患者下次不會到診)或「否」(患者下次會到診)。請問在進行特徵工程時,可能執行下列哪兩種作業?(請選擇2個答案。)</code></pre>"
    ],
    "options": [
      "<code>將「是」與「否」編碼為數值</code>",
      "<code>將病症編碼為數值</code>",
      "<code>為了在此資料集上進行實驗,選取最佳分類演算法</code>",
      "<code>評估在開發AI時,是否能滿足患者的隱私權需求</code>",
      "<code>對AI演算法進行超引數調整</code>",
      "<code>以上皆是</code>"
    ],
    "answer": [
      "A",
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>一個AI團隊實作的模型似乎有過度擬合的情況。請問這個團隊可以採取下列哪三種方法解決問題?(請選擇3個答案。)</code></pre>"
    ],
    "options": [
      "<code>收集更多資料</code>",
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>您建立了一個模型,並進行了測試。在實際部署之前,您決定先詢問客戶對模型的印象。在這個流程中,哪兩項必要的工作?(請選擇2個答案。)</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>一個組織靠連續管線將數量不斷增加的機器學習模型保持在最新狀態。請問生產環境AI作業中部署了下列哪兩種演算法?(請選擇2個答案。)</code></pre>"
    ],
    "options": [
      "<code>事件票證</code>",
      "<code>不可變基礎結構模式</code>",
    ...
    "image": null,
    "explanation": [
      "<pre><code>在生產環境中運維AI模型（MLOps）時：需部署了下列兩種演算法",
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>您開發了一個能向使用者推薦歌曲的AI,使用者可以選取「很棒」或「很糟」按鈕,對推薦歌曲提供回饋意見。請問接收使用者回饋意見會有下列哪三項優點?(請選擇3個答案。)</code></pre>"
    ],
    "options": [
      "<code>對推薦演算法的不同版本進行有效的A/B測試</code>",
    ...
    "explanation": [
      ...
      "● A/B測試： 可以將不同版本的推薦演算法推送給不同使用者群，根據他們的回饋（如點選率、評分）來比較演算法效果。",
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>一間公司想使用自動化作業簡化多項工作。請問下列哪三項工作適合採用AI 解決方案?(請選擇3個答案。)</code></pre>"
    ],
    "options": [
      "<code>理解檔案內容</code>",
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>下列哪兩項專案會因為使用AI建模而受益?(請選擇2個答案。)</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>下列哪兩種問題可以使用決策樹演算法解決?(請選擇2個答案。)</code></pre>"
    ],
    "options": [
      "分類",
      "回歸",
    ...
    "explanation": [
      ...
      "解題分析 (基於PDF答案2、3、5)： ",
      "* (2) 回歸： 決策樹可以處理回歸問題（預測連續值）。 ",
      "* (3) 叢集： 雖然決策樹主要用於監督學習，但有一些變種或與其他技術結合的方式可以間接用於或輔助叢集分析（例如，通過決策樹",
      "的葉節點來定義群組）。但它本身不是典型的叢集演算法。 ",
      "* (5) 文字產生： 傳統決策樹不直接用於文字產生。文字產生通常使用基於序列的模型，如RNN、LSTM、Transformer。",
      "解題分析 (標準答案1、2)： 決策樹的核心應用是分類和回歸。PDF提供的答案(3)和(5)與決策樹的典型用途有較大差異。",
      "決策樹演算法是一種監督式學習方法，主要用於解決以下兩類問題：",
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>下列哪三種演算法可以用於解決分類問題？（請選擇3個答案)</code></pre>"
    ],
    "options": [
      "<code>K-Means</code>",
      "<code>決策樹</code>",
    ...
    "image": null,
    "explanation": [
      "<pre><code>分類問題的目標是將輸入資料分配到預先定義的類別中。以下演算法可以用於解決分類問題：",
      "● 決策樹 (Decision Tree)： 是一種監督式學習演算法，可以透過學習資料特徵來建立樹狀模型，用於分類（預測離散類別）和回歸（預測連續值）。",
      "● 邏輯迴歸 (Logistic Regression)： 它是一種廣泛用於二元分類問題的監督式學習演算法，也可以擴充套件到多元分類。",
      "● SVM (Support Vector Machine，支援向量機)： 是一種強大的監督式學習演算法，常用於分類問題，也可以用於回歸。",
      "",
      "以下演算法不可以用於解決分類問題：",
      "● K-Means：是一種非監督式學習的叢集演算法，用於將資料分組，而不是預測類別標籤。因此不適用於分類問題。",
      "● 線性迴歸 (Linear Regression)： 是一種監督式學習演算法，用於預測連續數值輸出，不適用於分類問題。",
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>您訓練了一個模型,用於預測一間網路銀行的客戶流失率,但評估結果顯示這個模型的效能不佳。請問您可以使用下列哪兩種方法提升這個模型的效能?(請選擇2個答案。)</code></pre>"
    ],
    "options": [
      "<code>修改選取的特徵</code>",
      "<code>微調超引數</code>",
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>主管機構和使用者對於透明度的要求越來越高,尤其是針對AI模型。下列哪兩種檔案可協助開發人員為模型提供透明度保證?(請選擇2個答案。)</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>貴公司建置了AI技術,偵測萵苣是否發生病害。...您必須判斷在哪些情境下這個生產環境 AI可能故障,以便讓團隊事先準備應對策略。請問下列哪兩個情境是可能發生的問題?(請選擇2個答案。)</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>【【114】一間渦輪機製造商設計了AI,用於預測渦輪機是否可能起火。渦輪機從顯示故障跡象到實際起火只有不到100 毫秒的時間,因此AI必須在15毫秒內做出預測...請問下列哪兩種部署方式能使模型的反應最靈敏?”(請選擇2個答案。)</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>您是一間保險公司的員工,工作內容是協助資料科學家和工程師將新的模型部署至生產環境;這個模型會用於評估是否要核准客戶的理賠申請。您必須確保貴公司遵循業界與當地的最佳做法。請問您應該注意下列哪兩件事項?(請選擇2個答案。)</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>您一直在追蹤AI系統的指標,而一切運作看起來都如預期般順利。突然之間,您開始收到完全在意料之外的結果,與先前的結果有很大的不同。請問您應該先檢查下列哪兩項看似合理的肇因?(請選擇2個答案。)</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>您接手了與一套機器視覺系統相關的工作。進行偏差分析時,您發現這套系統對膚色較深的人無法有效做出反應。請問在這個情況下,您應該採取哪兩項合乎安全及道德的步驟?(請選擇2個答案。)</code></pre>"
    ],
    "options": [
      "<code>儘快讓系統離線</code>",
    ...
    "explanation": [
      ...
      "● 立即行動，控制影響： 如果偏差可能導致嚴重後果或不公平對待，應考慮暫時讓系統離線或限制其使用，直到問題解決。",
      "● 解決偏差： 根本的解決方法是改進模型，例如收集更多代表性不足群體的資料（如膚色較深的人的影象）來重新訓練模型，或採用去偏見的演算法。",
      "以下行動無關合乎安全及道德：",
      "● 降所有膚色種類的效能是不可取的，會降低整體效能。",
      "● 將系統的行銷市場微調成深色膚色人口比例較少的地點是逃避問題，而非解決。",
      "● 選升級用於實作演算法的軟體版本不一定能解決資料偏差問題。</code></pre>"
    ],
    "category": "D1_AI問題定義與倫理"
  },
  {
    ...
    "type": "multiple",
    "question": [
      "<pre><code>一間網路商店使用AI系統向網路顧客推薦加入訂單中的產品。請問您可以透過下列哪兩種顧客行為評估AI的效能?(請選擇2個答案。)</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>這三個模型使用的都是同一個資料集。請問下列哪一個模型是低度擬合?</code></pre>[[image01]]"
    ],
    "options": [
      "<code>模型圖形 1</code>",
      "<code>模型圖形 2</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>這三個模型使用的都是同一個資料集。請問下列哪一個模型是最佳的模型?</code></pre>[[image01]]"
    ],
    "options": [
      "<code>模型圖形 1</code>",
      "<code>模型圖形 2</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>這三個模型使用的都是同一個資料集。請問下列哪一個模型是過度擬合?</code></pre>[[image01]]"
    ],
    "options": [
      "<code>模型圖形 1</code>",
      "<code>模型圖形 2</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>貴公司建置了用在網路上推薦產品的AI，而您負責計劃如何建立生產管線並整合至網站。請問您應該將那件事納入考量?</code></pre>"
    ],
    "options": [
      "<code>假如網站顧客人數增加10倍，預測速度是否跟上</code>",
      "<code>預測成效是否良，能顧客買下推薦產品</code>",
      "<code>是否使用了最新AI演算法來推薦產品</code>",
      "<code>訓練AI演算法時使用顧客資料是否足夠</code>"
    ],
    "answer": [
      "A"
    ],
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>【補充】一家銀行希望自動識別信用卡交易中的潛在詐欺行為。這類交易非常罕見。請問這屬於哪種 AI 工作負載？</code></pre>"
    ],
    "options": [
    ...
    "image": null,
    "explanation": [
      "<pre><code>● **異常偵測** 專門用於識別與正常模式顯著不同的稀有事件或觀察結果，例如信用卡詐欺、裝置故障或網路入侵。● 物件偵測用於影像識別。● NLP 用於文書處理。● 知識探勘用於從非結構化資料中提取資訊。</code></pre>"
    ],
    "category": "D1_AI問題定義與倫理"
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>【補充】在電腦視覺中，哪項技術不僅能偵測影像中的物件，還能將影像中的「每個畫素」分類為特定標籤（例如道路、行人、天空）？</code></pre>"
    ],
    "options": [
    ...
    "image": null,
    "explanation": [
      "<pre><code>● **語義分割** (Semantic Segmentation) 涉及將影像中的每個畫素分配給一個類別，從而精確地描繪出物件的邊界。● 影像分類是對整張圖片給出一個標籤。● 物件偵測只會給出物件的邊界框 (Bounding Box)。</code></pre>"
    ],
    "category": "D3_AI演算法與模型"
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>【補充】您正在開發一個聊天機器人，需要從使用者的輸入句子「我想預訂明天去臺北的機票」中，提取出「明天」和「臺北」這類關鍵資訊。這屬於 NLP 中的哪項功能？</code></pre>"
    ],
    "options": [
    ...
    "image": null,
    "explanation": [
      "<pre><code>● **命名實體辨識 (NER)** 旨在識別文字中的特定實體，如日期（明天）、地點（臺北）、人名、組織等。● 情感分析判斷情緒正負向。● 關鍵短語擷取是提取重點主題而非特定實體類別。</code></pre>"
    ],
    "category": "D1_AI問題定義與倫理"
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>【補充】在訓練 AI 模型時，為了保護個人隱私，您在資料集中加入雜訊，使得無法從輸出反推回特定個人的資料。這符合「負責任 AI」的哪項原則？</code></pre>"
    ],
    "options": [
    ...
    "image": null,
    "explanation": [
      "<pre><code>● **隱私權與安全性** 原則要求保護使用者資料。題目描述的技術稱為「差異化隱私 (Differential Privacy)」，是保護隱私的常見技術手段。● 公平性是關於不歧視。● 透明度是關於模型的可解釋性。</code></pre>"
    ],
    "category": "D2_資料收集、處理與工程"
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>【補充】在準備機器學習的資料時，若特徵 A 的範圍是 0-1，而特徵 B 的範圍是 0-10000，這可能會導致某些演算法（如 KNN 或 梯度下降）效能不佳。您應該執行什麼步驟來解決此問題？</code></pre>"
    ],
    "options": [
    ...
    "image": null,
    "explanation": [
      "<pre><code>● 當特徵之間的數值範圍差異過大時，會影響基於距離的演算法（如 KNN）或最佳化過程。**特徵縮放**（如歸一化或標準化）可以將所有特徵調整到相似的範圍，確保模型公平地對待每個特徵。</code></pre>"
    ],
    "category": "D2_資料收集、處理與工程"
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>【補充】您正在評估一個預測罕見疾病的模型。該資料集中只有 1% 的樣本是陽性（有病）。在此情況下，僅看「準確率 (Accuracy)」可能會產生誤導。您應該優先參考哪項指標來平衡考量精確率 (Precision) 和召回率 (Recall)？</code></pre>"
    ],
    "options": [
    ...
    "image": null,
    "explanation": [
      "<pre><code>● 在資料極度不平衡的情況下，**F1 分數** 是更好的指標，因為它是精確率和召回率的調和平均數，能更真實地反映模型對少數類別的預測能力。● MAE 和 R 平方是用於迴歸問題的指標。</code></pre>"
    ],
    "category": "D2_資料收集、處理與工程"
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>【補充】關於自動化機器學習 (AutoML)，下列敘述何者正確？</code></pre>"
    ],
    "options": [
      "<code>它可以自動嘗試多種演算法和超引數組合，以找出最佳模型</code>",
    ...
    "image": null,
    "explanation": [
      "<pre><code>● **AutoML** 的主要優勢在於自動化特徵工程、模型選擇和超引數調整的過程，幫助開發者快速找到表現最好的模型。● 它仍然需要訓練資料，且廣泛用於監督式學習（分類、迴歸）。</code></pre>"
    ],
    "category": "D1_AI問題定義與倫理"
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>【補充】您希望將訓練好的 AI 模型部署到雲端、邊緣裝置等多種環境中，且保證執行環境的一致性。下列哪項技術最適合？</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>【補充】知識探勘 (Knowledge Mining) 解決方案中，「索引 (Indexer)」的主要作用是什麼？</code></pre>"
    ],
    "options": [
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>【補充】關於卷積神經網路 (CNN)，下列敘述何者最準確？</code></pre>"
    ],
    "options": [
      "<code>它特別擅長處理影像資料，利用卷積層提取特徵</code>",
      "<code>它主要用於處理時間序列資料</code>",
      "<code>它是一種非監督式學習演算法</code>",
  ...
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>【補充】在設計聊天機器人 (Chatbot) 時，使用者的輸入句子為「幫我預訂一張去倫敦的機票」。\n其中「預訂機票」代表使用者的什麼？「倫敦」又代表什麼？</code></pre>"
    ],
    "options": [
    ...
    "image": null,
    "explanation": [
      "<pre><code>● **意圖 (Intent)**：使用者想要達成的目標或動作（如：訂票、查詢天氣）。● **實體 (Entity)**：意圖中具體的細節或引數，用來補充說明意圖（如：地點、時間、數量）。</code></pre>"
    ],
    "category": "D1_AI問題定義與倫理"
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>【補充】某款 AI 應用程式可以分析照片中的人臉，並估測出該人物的「年齡」和「情緒」，但「不知道」這個人是誰。\n這屬於電腦視覺中的哪項功能？</code></pre>"
    ],
    "options": [
    ...
    "image": null,
    "explanation": [
      "<pre><code>● **臉部特徵分析**：分析臉部屬性（如年齡、性別、情緒、是否戴眼鏡），但不涉及確認身分。● **臉部識別**：將臉部與資料庫比對，回答「這是誰？」。● **臉部驗證**：比對兩張臉是否為同一人（1對1比對，如手機解鎖）。</code></pre>"
    ],
    "category": "D1_AI問題定義與倫理"
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>【補充】自動駕駛汽車的 AI 系統必須經過嚴格測試，確保在惡劣天氣或突發狀況下也能安全運作，不會對人類造成傷害。\n這最主要符合微軟「負責任 AI」的哪項原則？</code></pre>"
    ],
    "options": [
    ...
    "image": null,
    "explanation": [
      "<pre><code>● **可靠性與安全性**：強調 AI 系統在預期和非預期的情況下（如極端條件）都能穩定、安全地執行，且不會對人身安全造成威脅。● 隱私權與安全性：側重於資料保護。</code></pre>"
    ],
    "category": "D1_AI問題定義與倫理"
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>【補充】關於「迴歸模型 (Regression)」的評估指標，下列敘述何者正確？</code></pre>"
    ],
    "options": [
    ...
    "image": null,
    "explanation": [
      "<pre><code>● **R 平方 (Coefficient of Determination)**：衡量模型解釋變異的比例，範圍 0-1，越接近 1 表示模型解釋力越強。● MAE 和 RMSE 都是衡量「誤差」，所以數值越「小」越好。● 混淆矩陣是用於「分類」問題。</code></pre>"
    ],
    "category": "D3_AI演算法與模型"
  },
  {
    ...
    "type": "single",
    "question": [
      "<pre><code>【補充】您正在使用「翻譯服務 (Translator)」開發一個應用程式，該程式需要將使用者的「語音」即時翻譯成另一種語言的「語音」。\n請問正確的處理流程通常為何？</code></pre>"
    ],
    "options": [
