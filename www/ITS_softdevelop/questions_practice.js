const quizData = [
    ...
    },
    {
        "id": 2,
        "question": [
            "<pre><code>你建立了一個應用程式，其中包含一個名為 Red 的函式。",
        ...
        "explanation": [
            "<pre><code>A. 函式呼叫儲存在堆疊上。   //但沒有提到執行完成後如何處理",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>因第一個條件成立，直接賦值為 10，後續條件不執行。</code></pre>"
        ],
        "weight": 1,
        "image": null,
        "type": "single",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>因前兩個條件判斷皆為假，執行 else 分支，將 result 賦值為 30。</code></pre>"
        ],
        "weight": 1,
        "image": null,
        "type": "single",
    ...
    },
    {
        "id": 5,
        "question": [
            "<pre><code>在例外狀況處理常式中，catch 區段的用途為何？</code></pre>"
        ],
        "options": [
            "不論是否擲回例外狀況都執行程式碼",
            "只有在擲回例外狀況時才執行程式碼",
    ...
    },
    {
        "id": 11,
        "question": [
            "<pre><code>有一個堆疊包含整數值，這些值會按照下列順序推入堆疊：2、4、6、8。",
            "您執行了下列作業序列：",
            "Pop",
            "Push 3",
            "Pop",
    ...
    },
    {
        "id": 12,
        "question": [
            "<pre><code>您任職於某個應用程式開發團隊。應用程式存放於 Git 檔控制系統中。您計劃將一項新功能加入至應用程式，這項功能需要數週的時間來完成。",
    ...
    },
    {
        "id": 13,
        "question": [
            "<pre><code>請將清單中的每個版本控制系統命令，移至正確的描述位置：",
            "命令：",
            "1. branch",
            "2. checkout",
            "3. commit",
        ...
        "explanation": [
            "<pre><code>註:上述命令與描述選項似乎都是打散應依實際中文描述的順序, 然後挑選命令英文數字編號",
            "解題步驟",
    ...
    },
    {
        "id": 15,
        "question": [
            "<pre><code>哪一個詞能描述將物件的實值型別轉換成參考型別的程序？</code></pre>"
        ],
        "options": [
            "Boxing",
            "Unboxing",
    ...
    },
    {
        "id": 17,
        "question": [
            "<pre><code>哪一個詞能描述自現有類別繼承功能的 C# 類別？</code></pre>"
        ],
        "options": [
            "基底類別",
            "衍生類別",
    ...
    },
    {
        ...
        "explanation": [
            ...
            "<b>3. 選項逐一解析：</b></code></pre>",
            "<pre><code>A.僅 m1 和 m3 -> 漏掉了父類別 B 的 m2。",
    ...
    },
    {
        "id": 19,
        "question": [
            "<pre><code>哪一個詞能描述將物件轉換成較一般類型的程序？</code></pre>"
        ],
        "options": [
            "向上轉型",
            "向下轉型",
        ...
        "explanation": [
            ...
            "<b>1. 轉型方向圖解：</b>",
            "<pre><code class=\"language-csharp\">【父類別：Canvas】 (較一般/泛用)   ▲\n                                 │\n                                 ║  <b>向上轉型 (Upcasting)</b>\n【子類別：PictureCanvas】 (較特殊) ║  ✅ 隱式轉換 (自動進行)\n         └───────────────────────╝</code></pre>",
            "<b>2. 轉換特性對照表：</b>",
    ...
    },
    {
        "id": 20,
        "question": [
            "<pre><code>衍生類別可以覆寫哪一種函式？</code></pre>"
        ],
        "options": [
            "static 函式",
            "private virtual 函式",
    ...
    },
    {
        "id": 21,
        "question": [
            "<pre><code>下列哪一項敘述正確描述了在基底類別中宣告為虛擬的 C# 方法？</code></pre>"
        ],
        "options": [
            "衍生類別的實作看不到此方法",
            "可透過衍生類別本身的實作覆寫此方法",
        ...
        "explanation": [
            "<pre><code>B. 可透過衍生類別本身的實作覆寫此方法</code></pre>"
        ],
        "weight": 1,
        "image": null,
        "type": "single",
    ...
    },
    {
        ...
        "explanation": [
            ...
            "<b>1. 顯式介面實作</b>",
            "<pre><code class=\"language-csharp\">使用 <code>void IDisplayResult.Display()</code> 這種寫法時，該方法不會在類別實例中直接暴露，只能透過介面型別來存取。",
            "<b>2. 程式碼完整範例</b>",
            "public class FootRace : Race, IDisplayResult\n{\n    public override void Display() { \n        Console.WriteLine(Seconds); \n    }\n    public void DisplayRaw() { \n        Console.WriteLine(Seconds / 60d + \" minutes\"); \n    }\n    void IDisplayResult.Display() { \n        Console.WriteLine(Seconds + \" seconds\"); \n    }\n}",
            "<b>3. 呼叫流程與輸出說明</b>",
            "var r1 = new FootRace();\nvar r2 = r1 as IDisplayResult;\nr1.Seconds = 99;\n\nr1.Display();      // 輸出：99\nr2.Display();      // 輸出：99 seconds\nr1.DisplayRaw();   // 輸出：1.65 minutes</code></pre>",
            "<pre><code><b>小結</b>",
            "透過不同型別的參考 (r1 vs r2)，同一個物件可以表現出不同的行為版本。</code></pre>"
        ],
        "weight": 1,
        "image": null,
        "type": "single",
    ...
    },
    {
        "id": 23,
        "question": [
            "<pre><code>您需要將所有樣式設定分組成個別的檔案，以便套用至 Web 應用程式的所有頁面。請問您該怎麼做？</code></pre>"
        ],
        "options": [
            "使用內部樣式表。",
            "使用內嵌樣式。",
    ...
    },
    {
        "id": 24,
        "question": [
            "<pre><code>您正在開發一個 Web 程式，您需要使用階層式樣式表（CSS）建立上列圖形：綠色漸層至黑色的矩形。",
            "請選擇正確的選項以完成句子。",
    ...
    },
    {
        "id": 25,
        "question": [
            "<pre><code>您正在開發一個 Web 程式，您需要使用階層式樣式表（CSS）建立上列圖形：",
            " ",
            "請選擇正確的選項以完成句子。",
            "對於 background-image 樣式，您應該使用此值：</code></pre>"
        ],
        ...
        "explanation": [
            "<pre><code>選項 A：10px; 是設定 CSS 的 border-radius 值，使元素四個角都為 10px 的圓角，符合題目圖示。",
    ...
    },
    {
        "id": 26,
        "question": [
            "<pre><code>您正在建立一個 Web 應用程式。即將存取該應用程式的用戶端電腦會執行各種網頁瀏覽器。",
        ...
        "explanation": [
            "<pre><code>A.轉型\t//指資料或程式的型別轉換(如資料型態轉換、語言轉換等)，與題目無直接關聯。 ",
    ...
    },
    {
        "id": 27,
        "question": [
            "<pre><code>請選取正確的選項以完成句子。所有網頁伺服器都有___位址和網域名稱，用以在網際網路上識別其身分。</code></pre>"
        ],
        "options": [
            "FTP",
            "HTML",
        ...
        "explanation": [
            "<pre><code>A. FTP\t//FTP(File Transfer Protocol)是用於傳輸檔案的協議，與伺服器的「位址」無直接關聯。",
    ...
    },
    {
        "id": 28,
        "question": [
            "<pre><code>請選取正確的選項以完成句子。所有網頁伺服器會經由___通訊協定接受用戶端要求，然後以網頁的形式將資料傳回用戶端來回應。</code></pre>"
        ],
        "options": [
            "FTP",
            "HTML",
        ...
        "explanation": [
            "<pre><code>A. FTP\t//用於檔案傳輸(如下載或上傳檔案)，但非網頁資料交換的標準協定。",
    ...
    },
    {
        "id": 29,
        "question": [
            "<pre><code>請選取正確的選項以完成句子。擁有存取權的用戶端可以經由___通訊協定，修訂或移除裝載在網頁伺服器上的內容。</code></pre>"
        ],
        "options": [
            "FTP",
            "HTTP",
        ...
        "explanation": [
            "<pre><code>A. FTP\t//用於檔案傳輸(如下載或上傳檔案) 支援使用者透過客戶端(如FileZilla)與伺服器互動",
    ...
    },
    {
        "id": 30,
        "question": [
            "<pre><code>哪一個程序會將資料轉換為 Web 服務所用的 XML 字串？</code></pre>"
        ],
        "options": [
            "還原序列化",
            "序列化",
        ...
        "explanation": [
            "<pre><code>A.還原序列化\t//指將序列化的資料(如 XML)轉換回原始物件的過程(即反序列化)。",
    ...
    },
    {
        "id": 31,
        "question": [
            "<pre><code>請選取正確的選項以完成圖表。請在圖表中指出 MVC 架構模式的正確元件對應順序。",
        ...
        "explanation": [
            "<pre><code>在 MVC（Model-View-Controller）架構中，元件的流程通常如下:",
    ...
    },
    {
        "id": 32,
        "question": [
            "<pre><code>請完成圖表以解說 MVC 架構的核心功能。請將每個動作移至正確的位置。",
            "1. 將事件轉換成要求",
            "2. 顯示資料",
            "3. 解譯並傳遞資料",
            "4. 使用者點選按鈕",
    ...
    },
    {
        "id": 33,
        "question": [
            "<pre><code>您正在檢閱一項資料庫設計。此設計的其中一部分如下圖所示。哪一個詞能描述 Customer 與 Order 之間的關聯性？</code></pre>"
        ],
        "options": [
            "多對多",
            "多維",
        ...
        "explanation": [
            "<pre><code>一個 Customer（顧客）可以有多個 Order（訂單），但每筆 Order 只能屬於一個 Customer，因此這是典型的「一對多」關聯性</code></pre>"
        ],
        "weight": 1,
    ...
    },
    {
        "id": 34,
        "question": [
            "<pre><code>有一個名為 Items 的資料表，其欄位包括：",
        ...
        "explanation": [
            "<pre><code>選項A 是唯一符合以下條件的正確語法： ",
            "<pre><code>1. 使用 DELETE FROM <b>table_name</b> WHERE <b>condition</b>。 ",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>A. TRY TRAN;\t// SQL中無 TRY TRAN 語法，TRY 通常用於 TRY-CATCH (錯誤處理)，與交易開始無關",
    ...
    },
    {
        "id": 38,
        "question": [
            "<pre><code>哪一個 LINQ 運算子會壓平合併序列？</code></pre>"
        ],
        "options": [
            "SelectMany",
            "GroupBy",
        ...
        "explanation": [
            "<pre><code>問題：哪一個 LINQ 運運算元會「壓平合併序列」？ ",
    ...
    },
    {
        "id": 39,
        "question": [
            "<pre><code>如何設定 NoSQL 文件資料庫的資料結構？</code></pre>"
        ],
        "options": [
            "設為 XML",
            "使用兩個資料行：",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>A. char\t\t//無法儲存多字元的資料（如 \"123.45abc\"），也不支援小數點與非數字字元。",
    ...
    },
    {
        "id": 44,
        "question": [
            "<pre><code>在例外狀況處理程式中，finally 段的用途為何？</code></pre>"
        ],
        "options": [
            "僅出錯時處理常式",
            "僅支援應用程式的執行作業",
        ...
        "explanation": [
            "<pre><code>finally 段是 try 與 catch 結構的一部分，其核心功能是確保在 try 塊執行完畢後，無論是否發生例外（exception），finally 中的程式碼都必須執行。",
            "A. 僅出錯時處理常式",
            "B. 僅支援應用程式的執行作業",
            "C. 只有在遇回例外狀況時才輸入程式碼",
    ...
    },
    {
        "id": 46,
        "question": [
            "<pre><code>請檢視 Winter Sports Corporation 的下列軟體需求規格：</code></pre>[[image01]]<pre><code>根據所需的系統功能，您應該選擇哪一種架構？</code></pre>"
        ],
        "options": [
    ...
    },
    {
        "id": 48,
        "question": [
            "<pre><code>請根據 Git 的常見操作流程，將下列詞語移至正確位置。",
            "詞語：",
            "1.合併        2.提取要求        3.推送",
            "4.分支        5.認可           6.複製",
            "",
    ...
    },
    {
        "id": 49,
        "question": [
            "<pre><code>您的團隊使用了 GitHub 做為版本控制系統。",
            "您想要正確地將頁面填入完成的碼",
            "</code></pre>"
        ],
        "options": [
        ...
        "explanation": [
            "<pre><code>A. 複製 (Clone)\t\t// 用於第一次把遠端專案下載到本機，並不是回報變更之前必要的最後一步。",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>A. 複製 (Clone)\t//會把整個遠端儲存庫複製到本地，是初次取得專案的方式。  不符合「非複製模式」",
    ...
    },
    {
        "id": 52,
        "question": [
            "<pre><code>請選擇正確的選項以完成有關資料化加密的句子：",
            "數位簽章會使用？</code></pre>"
        ],
        "options": [
            "非對稱加密",
        ...
        "explanation": [
            "<pre><code>A. 非對稱加密\t//公鑰與私鑰機制，以確保資料完整性與來源真實性",
    ...
    },
    {
        "id": 54,
        "question": [
            "<pre><code>在類別中，建構函式的用途為何？</code></pre>"
        ],
        "options": [
            "建立實值型別",
            "自基底類別繼承",
    ...
    },
    {
        "id": 55,
        "question": [
            "<pre><code>您正在為應用程式設計一個 C# 類別。您需要讓 AccessCount 欄位變數只有在類別內可用。請問應該使用哪個存取修飾詞？</code></pre>"
        ],
        "options": [
            "internal",
            "private",
        ...
        "explanation": [
            "<pre><code>A. internal\t//同一程式集內的類別可訪問，但不同程式集的類別無法訪問。",
    ...
    },
    {
        "id": 58,
        "question": [
            "<pre><code>有一個名為 Mammal 的類別衍生自一個名為 Animal 的父類別。",
    ...
    },
    {
        "id": 59,
        "question": [
            "<pre><code>下列何者必須存在，才能從特定類別推導出繼承性？</code></pre>"
        ],
        "options": [
            "has-a 關聯",
            "is-a 關聯",
        ...
        "explanation": [
            "<pre><code>A. has-a 關聯\t//表示「擁有某個東西」的關係，例如： Car has-a Engine，這是組合或聚合的關係。",
    ...
    },
    {
        "id": 60,
        "question": [
            "<pre><code>有一個名為 Glass 的類別繼承自 Window 類別。Window 類別中包含一個名為 break() 的受保護方法。",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>C. 3  //_number 預設為 7, 有一個 int 的建構子, 當執行 ANumber mynumber = new ANumber(3); 會是3</code></pre>"
        ],
        "weight": 1,
        "image": null,
        "type": "single",
    ...
    },
    {
        "id": 62,
        "question": [
            "<pre><code>Circle 和 Square 這兩個類別繼承自 Shape 類別，並且都繼承並以不同方式實作 Area 方法。請問這代表哪一種物件導向的概念？</code></pre>"
        ],
        "options": [
            "封裝",
            "抽象化",
        ...
        "explanation": [
            "<pre><code>A.封裝\t//將資料與方法封裝於物件中，透過訪問控制(如 private、protected)限制對內部狀態的直接存取",
    ...
    },
    {
        "id": 63,
        "question": [
            "<pre><code>您正在撰寫一個處理訂房要求的 web 應用程式。",
        ...
        "explanation": [
            "<pre><code>A. 批次處理\t//是指定時執行的背景作業(例如每天晚上清理資料) 不適合即時判斷房間是否可用",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>A. FTP\t//是一種檔案傳輸協定，不是用來識別伺服器身分",
            "B. HTML\t//是網頁內容的語言，不是識別位址",
            "C. HTTP\t//是通訊協定，用於傳輸網頁資料，但不是「位址」",
            "D. IP\t//是網際網路上的數字位址，用來識別伺服器位置</code><//pre>"
        ],
        "weight": 1,
        "image": null,
        "type": "single",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>A. FTP\t//是檔案傳輸協定，用於上傳/下載檔案，不是用來傳送網頁資料",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>A. FTP (File Transfer Protocol)：專門用來在客戶端與伺服器之間傳輸檔案。 如果有權限，就能「上傳、下載、",
            "\t修改、刪除」伺服器上的檔案，符合題目需求 → 正解！",
            ...
            "D. SMTP (Simple Mail Transfer Protocol)：用來傳送電子郵件。和網頁伺服器檔案管理無關。</code></pre>"
        ],
        "weight": 1,
        "image": null,
        "type": "single",
    ...
    },
    {
        "id": 67,
        "question": [
            "<pre><code>您的網站（sunsetweb.org）需要 SSL。",
            "您使用如下圖所示的設定建立了一個虛擬目錄。</code></pre>[[image01]]<pre><code>您將 Overview.jpg 檔案儲存在虛擬目錄中。",
    ...
    },
    {
        "id": 68,
        "question": [
            "<pre><code>下列 REST API Web 服務程式碼會在 www.sunsetweb.com 網域上執行：",
    ...
    },
    {
        "id": 69,
        "question": [
            "<pre><code>哪一個正規化要求資料表的屬性僅相依於主索引鍵？</code></pre>"
        ],
        "options": [
    ...
    },
    {
        "id": 70,
        "question": [
            "<pre><code>您需要建立一個傳入人員 UserName 和 Age 的預存程序。",
            "Age 必須是以年為單位的整數。",
            "UserName 至少必須有三個字元。",
            "您應該使用哪一個陳述式來建立此預存程序？",
            "選項：",
        ...
        "explanation": [
            ...
            "CREATE PROCEDURE 名字 @變數1 型別, @變數2 型別</code> "
        ],
        "weight": 1,
        "image": null,
        "type": "single",
    ...
    },
    {
        "id": 71,
        "question": [
            "<pre><code>在更新資料庫的多個資料表時，使用交易有何優點？</code></pre>"
        ],
        "options": [
            "更新不會失敗。",
            "更新會以單位的形式成功或失敗。",
    ...
    },
    {
        "id": 72,
        "question": [
            "<pre><code>您有一部限制資料連線數目的伺服器。您應該使用下列何者，在使用者數目超過可用的連線數目時將連線能力最佳化？</code></pre>"
        ],
        "options": [
            "連線共用",
            "連線逾時",
        ...
        "explanation": [
            "<pre><code>A. 連線共用\t#連線數有限時，共用連線池可以讓多個使用者重複使用現有連線，免新建連線，最佳化效能與資源利用",
    ...
    },
    {
        "id": 73,
        "question": [
            "<pre><code>您應該在有效的單元測試案例中納入哪兩種資訊？（請選擇 2 個答案）</code></pre>"
        ],
        "options": [
            "測試案例必要的任何前置條件 ",
            "測試案例的預期結果",
        ...
        "explanation": [
            "<pre><code>A. 測試案例必要的任何前置條件\t#單元測試必須先設定測試環境或前提條件, 例如輸入資料、初始狀態",
    ...
    },
    {
        "id": 74,
        "question": [
            "<pre><code>下列哪兩項敘述正確描述了 JSON 物件？（請選擇 2 個答案）</code></pre>"
        ],
        "options": [
            "JSON 物件可使用名稱/值對來建立。",
        ...
        "explanation": [
            "<pre><code>A. JSON 物件可使用名稱/值對來建立。      # JSON 基本結構就是 key:value 配對",
    ...
    },
    {
        "id": 75,
        "question": [
            "<pre><code>下列哪兩項敘述正描述了將資料庫正規化的優點？</code></pre>"
        ],
        "options": [
            "正規化可降低磁碟空間使用量。",
            "正規化可防止資料不一致。",
        ...
        "explanation": [
            "<pre><code>A. 正規化可降低磁碟空間使用量。\t#正規化主要透過「消除重複資料」來減少磁碟空間浪費。",
    ...
    },
    {
        "id": 76,
        "question": [
            "<pre><code>連線共用有哪三項優點？（請選擇 3 個答案。）</code></pre>"
        ],
        "options": [
            "提升效能",
            "提升可擴縮性",
        ...
        "explanation": [
            "<pre><code>A. 提升效能\t\t#因為重複使用現有連線，減少建立/關閉連線的開銷。",
    ...
    },
    {
        "id": 77,
        "question": [
            "<pre><code>哪兩個程式碼片段可用來確保資源釋出？（請選擇 2 個答案。）</code></pre>"
        ],
        "options": [
            "using 陳述式",
            "using 指示詞",
        ...
        "explanation": [
            "<pre><code>A. using 陳述式\t// C# 的 using 陳述式(using (...) { ... })在區塊結束時會自動呼叫 Dispose()，作資源釋放。",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>A. Yes      //只測試單一功能或最小程式單元(如函式、方法或類別)",
    ...
    },
    {
        "id": 79,
        "question": [
            "<pre><code>單元測試方法會呼叫目前測試的方法、傳遞資料，然後檢查傳回值是否正確。</code></pre>"
        ],
        "options": [
            "Yes",
            "No"
    ...
    },
    {
        "id": 80,
        "question": [
            "<pre><code>單元測試的主要目標是取出應用程式中最小的可測試軟體部分，將此部分與其於程式碼隔離，",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>A. Yes   #連結清單可以進行排序，只是操作方式是透過遍歷和指標調整，而不是像陣列用索引存取。",
    ...
    },
    {
        "id": 82,
        "question": [
            "<pre><code>連結清單最多包含 100 個節點。</code></pre>"
        ],
        "options": [
            "Yes",
            "No"
    ...
    },
    {
        "id": 83,
        "question": [
            "<pre><code>您可以在連結清單(Linked List)內任何位置加入新的節點。</code></pre>"
        ],
        "options": [
            "Yes",
            "No"
        ...
        "explanation": [
            "<pre><code>A. Yes    //連結清單的特點就是 可以在任意位置插入或刪除節點，這是它相對於陣列 (Array) 的優勢</pre></code>"
        ],
        "weight": 1,
        "image": null,
        "type": "single",
    ...
    },
    {
        "id": 84,
        "question": [
            "<pre><code>數位簽章會使用寄件者的公開金鑰來加密訊息。</code></pre>"
        ],
        "options": [
            "Yes",
            "No"
        ...
        "explanation": [
            "<pre><code>B. No   //數位簽章 (Digital Signature) 的流程跟「加密訊息」不太一樣，重點是用私鑰簽署、用公鑰驗證：",
			"關鍵點：",
    ...
    },
    {
        "id": 85,
        "question": [
            "<pre><code>CSRF（跨網站偽造要求）權杖是用來防止攻擊。</code></pre>"
        ],
        "options": [
            "Yes",
            "No"
        ...
        "explanation": [
            ...
            "<pre><code>A. Yes      // CSRF 權杖是 主動防禦機制，直接針對 CSFR 攻擊的漏洞，它的設計目的明確是防止攻擊。 </code></pre>",
			"[[image01]]"
        ],
        "weight": 1,
        "image": null,
    ...
    },
    {
        "id": 86,
        "question": [
            "<pre><code>防止 SQL 插入式攻擊的其中一種方式就是逸出使用者輸入。</code></pre>"
        ],
        "options": [
            "Yes",
            "No"
    ...
    },
    {
        "id": 87,
        "question": [
            "<pre><code>Person 類別中的方法可以存取 co1or 屬性。</code></pre>"
        ],
        "options": [
            "Yes",
            "No"
        ...
        "explanation": [
            "<pre><code>Person類中的方法可以訪問該類的屬性color，只要該屬性是公開的或者在類的範圍內。</code></pre>"
        ],
        "weight": 1,
        "image": null,
        "type": "single",
    ...
    },
    {
        "id": 88,
        "question": [
            "<pre><code>某個專案包含一個名為 Person 的類別，以及一個名為 Tree 類別。",
        ...
        "explanation": [
            "<pre><code>※因Person類別與Tree類別無繼承關係，且未明確在同一包內，Person類別的方法 無法訪問Tree的protected屬性。因此正確答案為 B. No。</code></pre>"
        ],
        "weight": 1,
        "image": null,
        "type": "single",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>在軟體開發中，類別之間的私有屬性無法被其他類別直接訪問，因此 Tree 類別中的方法無法存取 Person 中的所有私用屬性",
            "正確答案為 B",
            "題目關鍵點分析",
            "1. 類別與屬性範圍",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>onload 是負責 處理伺服器回應，不是用來「傳送請求」",
            "重點解析：",
            "xhr.onload (第 02 行)",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>一般在考試的抽象資料結構角度，會認為佇列的項目數不一定有限制。",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>佇列是一種先進先出（FIFO, First-In-First-Out）的資料結構，其核心特性是：",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>※文件資料庫 (Document Database)",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>文件資料庫的設計目的 不是 以預先定義的關聯處理資料，而是以文件形式靈活儲存。</code></pre>"
        ],
        "weight": 1,
        "image": null,
        "type": "single",
    ...
    },
    {
        ...
        "explanation": [
            "<pre><code>索引鍵值資料庫不會把資料當成可查詢或修改屬性的物件，所以答案是 B. No</code></pre>"
        ],
        "weight": 1,
        "image": null,
        "type": "single",
    ...
    },
    {
        "id": 99,
        "question": [
            "<pre><code>實體關聯圖表（ERD）是專為物件導向的資料庫所設計。</code></pre>"
        ],
        "options": [
            "Yes",
            "No"
        ...
        "explanation": [
            "<pre><code>●ERD是實體關係圖，通常用於傳統的資料庫設計，比如關係型資料庫。它主要關注實體之間的關係。",
    ...
    },
    {
        "id": 100,
        "question": [
            "<pre><code>實體關聯圖表（ERD）包含實體、關聯和屬性。</code></pre>"
        ],
        "options": [
            "Yes",
            "No"
    ...
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>基數是指資料表的互相連結方式，例如一對多。</code></pre>"
        ],
        "options": [
            "一對一（1:1）",
            "一對多（1:N）",
        ...
        "image": null,
        "explanation": [
            "<pre><code>基數(Cardinality)料庫設計中指的是資料表之間的關聯性質，用來描述兩個實體之間的對應關係",
    ...
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【OOP-封裝】您正在設計一個銀行帳戶類別 `BankAccount`，其中的 `balance` (餘額) 欄位不應該讓外部程式碼直接修改，而應該透過 `Deposit()` 或 `Withdraw()` 方法來變更。請問您應該將 `balance` 設定為哪種存取修飾詞？</code></pre>"
        ],
        "options": [
            "public",
            "private",
    ...
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【OOP-多型】在 C# 中，如果父類別有一個方法 `Draw()`，而子類別想要提供該方法的不同實作（例如圓形和矩形的畫法不同），子類別應該使用哪個關鍵字？</code></pre>"
        ],
        "options": [
            "overload (多載)",
            "override (覆寫)",
        ...
        "image": null,
        "explanation": [
            "<pre><code><b>核心重點：多型 (Polymorphism) 的實現</b>",
    ...
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【OOP-類別與物件】關於類別 (Class) 與物件 (Object) 的敘述，下列何者正確？</code></pre>"
        ],
        "options": [
            "類別是藍圖，物件是根據藍圖建立的實體",
            "物件是藍圖，類別是實體",
        ...
        "image": null,
        "explanation": [
            "<pre><code>類別 (Class) 像是一個**模具或藍圖**，定義了屬性與行為；而物件 (Object) 是使用 `new` 關鍵字根據類別建立出來的具體**實體 (Instance)**。</code></pre>"
        ],
        "category": "D2_物件導向程式設計"
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【ALM-生命週期】在應用程式生命週期管理 (ALM) 中，哪個階段主要負責定義「系統必須做什麼」以及蒐集使用者需求？</code></pre>"
        ],
        "options": [
            "設計 (Design)",
            "測試 (Testing)",
        ...
        "image": null,
        "explanation": [
            "<pre><code>**需求分析**階段的目標是釐清使用者的痛點與需求，產出規格書，確認「要做什麼 (What)」。設計階段則是規劃「如何做 (How)」。</code></pre>"
        ],
        "category": "D3_一般軟體開發"
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【ALM-測試】開發人員在寫完一個函式後，撰寫了一小段程式碼來驗證該函式的邏輯是否正確。這種測試稱為？</code></pre>"
        ],
        "options": [
            "單元測試 (Unit Testing)",
        ...
        "image": null,
        "explanation": [
            "<pre><code>**單元測試**是針對軟體中最小的可測試單元（通常是函式或方法）進行驗證，通常由開發人員自己撰寫。</code></pre>"
        ],
        "category": "D3_一般軟體開發"
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【Web-基礎結構】在網頁開發中，負責定義網頁「結構」與「內容」的是哪種語言？</code></pre>"
        ],
        "options": [
            "CSS",
            "JavaScript",
        ...
        "image": null,
        "explanation": [
            "<pre><code>**HTML** (HyperText Markup Language) 負責網頁的骨架與內容；",
            "**CSS** 負責樣式與美觀；",
    ...
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【Web-CSS】如果您希望網頁上的某個按鈕背景變成藍色，字型變成白色，您應該使用哪種技術？</code></pre>"
        ],
        "options": [
            "HTML",
        ...
        "image": null,
        "explanation": [
            "<pre><code>**CSS** 用於描述 HTML 元素的外觀樣式（如顏色、字型、排版）。</code></pre>"
        ],
        "category": "D4_Web應用程式"
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【Web-執行環境】JavaScript 程式碼通常是在哪裡執行的？</code></pre>"
        ],
        "options": [
            "資料庫伺服器",
            "網頁伺服器 (IIS/Apache)",
        ...
        "image": null,
        "explanation": [
            "<pre><code>雖然現在有 Node.js，但在傳統 Web 開發語境下，**JavaScript** 主要是在使用者的**瀏覽器 (Client-side)** 上執行，負責動態互動效果。</code></pre>"
        ],
        "category": "D4_Web應用程式"
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【Web-伺服器】哪一個術語是用來描述負責託管 (Hosting) 網頁應用程式並回應 HTTP 請求的軟體（如 IIS 或 Apache）？</code></pre>"
        ],
        "options": [
            "Web Browser",
            "Web Server",
    ...
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【OOP-抽象】關於抽象類別 (Abstract Class) 與介面 (Interface)，下列敘述何者正確？</code></pre>"
        ],
        "options": [
            "類別可以繼承多個抽象類別",
    ...
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【C#-記憶體】在 C# 中，參考型別 (Reference Type) 的物件實體通常儲存在記憶體的哪個區域？</code></pre>"
        ],
        "options": [
            "Stack (堆疊)",
            "Heap (堆積)",
    ...
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【ALM-排序】請排列軟體開發生命週期的正確順序：1.開發 2.需求分析 3.測試 4.設計 5.維護</code></pre>"
        ],
        "options": [
            "2 -> 4 -> 1 -> 3 -> 5",
            "1 -> 2 -> 3 -> 4 -> 5",
        ...
        "image": null,
        "explanation": [
            "<pre><code><pre><code><b>1. 選項拆解與階段分析</b>",
    ...
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【C#-集合】您需要儲存一個沒有重複元素的數列，應該使用哪種集合型別？</code></pre>"
        ],
        "options": [
            "List<int>",
            "Array",
        ...
        "image": null,
        "explanation": [
            "<pre><code><pre><code><b>1. 選項拆解與集合特性分析</b>",
    ...
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【Web-狀態】HTTP 協定本身是無狀態的 (Stateless)。為了在不同頁面間記住使用者的登入狀態，通常會使用什麼技術？</code></pre>"
        ],
        "options": [
            "HTML Tags",
            "CSS Styles",
    ...
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>在物件導向程式設計 (OOP) 中，哪一個術語可以用來描述「類別繼承」的關係？</code></pre>"
        ],
        "options": [
            "Has-a 關係 (擁有)",
            "Is-a 關係 (是一個)",
    ...
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【演算法-搜尋】在使用「二分搜尋法 (Binary Search)」搜尋特定數值之前，數列必須滿足哪一個先決條件？</code></pre>"
        ],
        "options": [
            "數列必須已經過排序 (Sorted)",
            "數列必須包含重複的元素",
    ...
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【演算法-排序】哪一種排序演算法的運作方式是「重複走訪要排序的數列，比較相鄰的兩個元素，並在順序錯誤時交換它們」？</code></pre>"
        ],
        "options": [
            "快速排序 (Quick Sort)",
            "合併排序 (Merge Sort)",
    ...
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【安全性-雜湊】關於「雜湊 (Hashing)」與「加密 (Encryption)」的差異，下列敘述何者正確？</code></pre>"
        ],
        "options": [
            "<pre><code>雜湊是雙向的，加密是單向的",
    ...
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【Web-服務】哪一個開放標準協定被廣泛用於「授權 (Authorization)」，允許使用者讓第三方應用程式存取其資源（如 Google 帳號資訊）而不需要分享密碼？</code></pre>"
        ],
        "options": [
            "JSON",
            "SOAP",
    ...
    },
    {
        ...
        "type": "single",
        "question": [
            "<pre><code>【架構-模式】在 MVVM 架構模式中，哪一個元件負責作為 Model 與 View 之間的橋樑，並處理資料繫結 (Data Binding) 的邏輯？</code></pre>"
        ],
        "options": [
            "Model",
            "View",
