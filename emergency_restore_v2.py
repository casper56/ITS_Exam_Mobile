...
<head>
    ...
    <style>
        ...
        .side-nav-btn { position: fixed; top: 55%; transform: translateY(-50%); width: 25px; height: 65px; background: rgba(13, 110, 253, 0.7); color: white; display: flex; align-items: center; justify-content: center; cursor: pointer; z-index: 2000; transition: all 0.3s ease; text-decoration: none; font-size: 1.1rem; border: none; box-shadow: none; outline: none !important; user-select: none; -webkit-tap-highlight-color: transparent; font-family: serif; font-weight: bold; }
...
with open(html_path, 'w', encoding='utf-8') as f:
    f.write(html_top + "    const allQuestions = " + json_str + ";" + html_bottom)

print("ITS_Python/mock_exam.html 徹底修復完成！")
