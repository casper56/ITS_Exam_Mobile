...
# 1. 定義頭部模板 (包含 CSS 與 HTML 結構)
template_head = r"""import json
import os
import glob
...
<head>
    ...
    <style>
        ...
        .progress-grid { display: flex; flex-wrap: wrap; gap: 4px; }
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <main class="content-area"><div class="container-fluid" style="width: calc(100% - 60px); margin: 20px auto;"><div id="question-container"></div></main>
    </div>
...
with open(path, 'w', encoding='utf-8') as f:
    f.write(header + template_head + template_foot + footer)

print("SUCCESS: Python generator fully rebuilt.")
